...
```
# Perform object detection with label in an image
```
...
## Output:
### Perform ROI from an image:
![image](https://github.com/user-attachments/assets/424001f2-a909-4ef3-b80b-959430e47d29)

### Perform handwritting detection in an image:
![image](https://github.com/user-attachments/assets/1babd4ac-7d2f-4c7a-8327-18e1d6c6e5c9)

### Perform object detection with label in an image:
![image](https://github.com/user-attachments/assets/9e36679a-e5e6-4580-a973-ac44f056ddf1)
